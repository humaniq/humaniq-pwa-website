...
const SE_HomeMeta = () => (
  <Helmet>
    ...
    <meta name="csrf-token"
          content="XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX=="/>
    <title>Humaniq</title>

    <meta name="description"
          content="Humaniq is a simple and secure 4th generation mobile banking app, based on Ethereum Blockchain."/>
    ...
    <meta name="twitter:description" content="Humaniq is a simple and secure 4th generation mobile banking app, based on Ethereum Blockchain." />
  </Helmet>
)

SE_HomeMeta.propTypes = {
};

SE_HomeMeta.defaultProps = {
}
export default SE_HomeMeta