...
class TeleFooter extends React.Component {
  ...
  handleLinkClick = () => {
    window.ga('send', 'event', 'other', 'telegram-btn-click');
  }
  ...
  render() {
    return (
            <div className={cn('tele-footer', this.state.isHidden ? 'is-hidden' : '')}>
                <a className="tele left" href="https://t.me/HMQtrader" target="_blank" onClick={() => {
                ...
                <a href="https://t.me/HMQtrader" target="_blank" onClick={() => {
                  this.handleLinkClick()
                }}>
                    Telegram
                </a>
                <a className="tele right" href="https://t.me/HMQtrader" target="_blank" onClick={() => {
                  this.handleLinkClick()
                }}>
                    <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
