    ...
    <div className={cn('content')}>
      ...
      <div className={cn('columns-wrapper')}>
        <div className={cn('text-column')}>
          <div className={cn('text-column-top')}>1 <span>billion</span></div>
          <div className={cn('text-column-bottom')}>new users in the<br/> coming years</div>
        </div>
        <div className={cn('text-column')}>
          <div className={cn('text-column-top')}>$4 <span>trillion</span></div>
          <div className={cn('text-column-bottom')}>potentially in<br/> user accounts</div>
        </div>
        <div className={cn('text-column')}>
          <div className={cn('text-column-top')}>200+</div>
          <div className={cn('text-column-bottom')}>start-ups are planning<br/> to move onto the<br/> Humaniq platform</div>
        </div>
      </div>
