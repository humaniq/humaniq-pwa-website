          ...
          <div className={cn('faq')}>
            ...
            <section className={cn('firstquestion')}>
              ...
              <ul>
                ...
                <li>You can receive tokens for free by doing simple actions in Humaniq app</li>
              </ul>
            </section>
            ...
            <section className={cn('question')}>
              ...
              <ul>
                <li>Invite your friends and text with them with secured chats</li>
                <li>Create and use a wallet</li>
                <li>Send or receive HMQ</li>
                <li>Get HMQ BONUS</li>
                <li>Participate in surveys and earn HMQ Tokens</li>
                <li>Trade or buy things via business chats</li>
                <li>Find some interesting content in info bots</li>
              </ul>
            </section>
            ...
            <section className={cn('question')}>
              ...
              <ol>
                ...
                <li>Inviting friends - you get a HMQ bonus for inviting friends after they have registered your promo code.</li>
            ...
            <section className={cn('question')}>
              ...
              <p className='d'>Please contact Support agent and inform that you want to delete your account. All your data will be deleted from our database.</p>
            </section>
            ...
            <section className={cn('question')}>
              ...
              <p className='d'>If you can&#39;t login or can&#39;t contact our live support, please, don&#39;t hesitate to use our Telegram support chat: <a href='https://t.me/humaniqsupport' target='_blank'>https://t.me/humaniqsupport</a></p>
            </section>
          </div>
        </A_Container>
      </div>
