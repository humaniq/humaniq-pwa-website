    ...
    sections: [
      {
        ...
        html:
          ...
          '<p class="d">(b) Phone Contact List Information: When you use the services of Humaniq App (Services) you voluntarily give us your phone contact list information (phone numbers and titles of contacts). That means that your phone contact list information will be collected and stored on our servers in order for us to be able to notify you when a user your have in your contact list installs Humaniq App and for the referral program to let you invite users to Humaniq App.</p>\n' +
          '<p class="d">(c) Additional Information: We collect additional information when you access Humaniq App through a certain device (e.g. your mobile device’s unique identifier, IP address). We may also collect your non-active location data – you can choose whether to allow this by changing your geolocation tracking settings.</p>\n' +
