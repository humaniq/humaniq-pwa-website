      ...
      <A_Button onClick={onClick} type="img">
        {x < max/2 ?
          <svg
            ...
            style={{
              transform: `scale(${1 - (0.01 * x)}) rotate(${- 180/100 * x}deg)`
            }}
          >
            <path
          ...
          : <svg
              ...
              viewBox="0 0 18 18"
              style={{
                transform: `scale(${0.01 * x}) rotate(${- 180/100 * x}deg) translate(2px,-1px)`,
              }}
            >
...
O_HeaderBtn.propTypes = {
};

O_HeaderBtn.defaultProps = {
}

export default O_HeaderBtn
